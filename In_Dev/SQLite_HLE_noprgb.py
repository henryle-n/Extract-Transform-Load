...
# create an folder to hold temporarily exported data of converted data
dirName = 'Cleaned_Data'
...
sqlite_db_path = os.path.join(fol_name,"imdb_movies.db")
...
with tqdm(total=len(values)) as pbar:   
    for index, row in processed_df.head(n=total_to_load).iterrows():
        ...
        print (f">>> Loading: \033[1;31m{'{:,.0f}'.format(i)}\033[0m Records | \033[1;32m{perc}%\033[0m Complete", end = "\r", flush=True)

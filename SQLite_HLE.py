...
# # SQL-Alchemy :: Load Cleaned Data to SQL Lite DB
# ---
# ---
...
with tqdm(total=len(values)) as pbar:
    for index, row in processed_df.head(n=total_to_load).iterrows():
        ...
        print (f">>> Loading: \033[1;31m{'{:,.0f}'.format(i)}\033[0;30m Records | \033[1;34m{perc}%\033[0;00m Complete", "\r", end ='' , flush=True)
